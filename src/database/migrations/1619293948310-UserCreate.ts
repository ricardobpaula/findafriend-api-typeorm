...
export class UserCreate1619293948310 implements MigrationInterface {
    name = 'UserCreate1619293948310'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "users_role_enum" AS ENUM('admin', 'commom')`);
